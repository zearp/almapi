...
repo --name="epel"        --mirrorlist="https://mirrors.fedoraproject.org/metalink?repo=epel-10&arch=$basearch"
...
part /boot --asprimary --fstype=vfat --size=500 --label=cidata --ondisk=sda
...
# Set power-profile (see: tuned-adm list)
tuned-adm balanced
